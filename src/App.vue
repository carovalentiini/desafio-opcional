...
export default {
          ...
          productos: [
              {
                  ...
                  descripcionLarga:"zapatikka modelo z, marxa z"
              },
              {
                  id: 2,
                  nombre: "Producto 2",
  ...
  methods: {
      mostrar: function (event) {
          let element = event.target;//el target en este caso es el boton
          let productoId = element.dataset.productoId;//no se usan guiones en js po reso se reemplaza producto-id por lowerCamel Case con productoId
